...
SELECT * FROM orders WHERE LOWER(ship_country) IN ('france', 'germany', 'spain')
...
SELECT AVG(shipped_date - order_date) as "average" FROM orders WHERE ship_country = 'Germany'
